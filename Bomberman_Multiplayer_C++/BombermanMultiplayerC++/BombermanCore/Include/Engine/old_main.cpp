...
int main(int argc, char** argv)
{
   ...
   std::function<void(int)> test = [&map](int index)
   {
     map.get()->BuildMap(index);
   };
   NetworkManager::MapIndexReceived.AddLambda(test);
  ...
  // NetworkManager::test();
   ...
   //NetworkManager::MapIndexReceived.Broadcast(0);
