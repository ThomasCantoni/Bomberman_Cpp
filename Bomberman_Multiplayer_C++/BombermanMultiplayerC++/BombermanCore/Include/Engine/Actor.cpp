...
namespace Bomberman
{
	...
	//SerialData Actor::Serialize() const
	//{
	...
	//	//data.networkID = ID;
	//	data.length = 16;
	//	data.data = new unsigned char[16];
	...
	//	size_x = byteconverter::FloatToBytes(pos.x);
	//	size_y = byteconverter::FloatToBytes(pos.y);

	//	byteconverter::BytesAppend(data.data,16, 0, buffer_x, sizeof(float));
	//	byteconverter::BytesAppend(data.data,16, 4, buffer_y, sizeof(float));
	//	byteconverter::BytesAppend(data.data,16, 8, size_x,	 sizeof(float));
	//	byteconverter::BytesAppend(data.data,16, 12,size_y,	 sizeof(float));
	//	return data;
	//}
