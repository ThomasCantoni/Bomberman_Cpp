...
typedef struct eggbomb
{
    ...
    SDL_Rect SDL_egg_rect;
    

    vec2_t center_position;
    int state;
    SDL_Texture* egg_texture;
} eggbomb_t;

typedef struct explosion
{
    vec2_t pivot_position;
    SDL_Rect SDL_bomb_rect;
...
//    //float magnitude = Magnitude(*ToNormalize);
//    //vec2_t result;
